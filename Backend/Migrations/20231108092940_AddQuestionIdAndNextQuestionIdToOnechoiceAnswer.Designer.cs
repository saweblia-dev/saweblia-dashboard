...
namespace Saweblia_Backend.Migrations
{
    ...
    [Migration("20231108092940_AddQuestionIdAndNextQuestionIdToOnechoiceAnswer")]
    partial class AddQuestionIdAndNextQuestionIdToOnechoiceAnswer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saweblia_Backend.Models.Answer", b =>
                {
                    ...
                    b.Property<int?>("OnechoiceAnswerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Saweblia_Backend.Models.Prestation", b =>
                {
                    ...
                    b.Property<bool?>("activation_prestation")
            ...
            modelBuilder.Entity("Saweblia_Backend.Models.Answer", b =>
                {
                    b.HasOne("Saweblia_Backend.Models.OnechoiceAnswer", null)
                        .WithMany("Answers")
                        .HasForeignKey("OnechoiceAnswerId");
            ...
            modelBuilder.Entity("Saweblia_Backend.Models.OnechoiceAnswer", b =>
                {
                    ...
                    b.HasOne("Saweblia_Backend.Models.Question", "NextQuestion")
                        .WithOne()
                        .HasForeignKey("Saweblia_Backend.Models.OnechoiceAnswer", "NextQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
