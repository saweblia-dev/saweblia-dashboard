                    ...
                    .map((prestation) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col items-start justify-between font-light text-gray-600">
                          <p className="text-[15px]">{prestation.libelle}</p>
            ...
            <div className="flex flex-col ml-10 w-[800px] max-h-[800px] overflow-y-scroll  rounded-md border border-slate-200">
             ...
             <div className="my-6 py-6 border-t border-gray-200">
               <div className="-mx-2 flex items-end justify-end">
                 ...
                 {/* <Button className="bg-red-300  " text="Modifier"/> */}
                 <button 
 
     className="w-[200px] bg-green-500 text-white max-w-xs mx-auto border border-transparent  hover:bg-gray-500 focus:bg-gray-500 text-white rounded-md px-5 py-2 font-semibold">
     Modifier
    </button>
                 </Link>
                 </div>
